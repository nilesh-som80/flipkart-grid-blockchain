...
<main id="content">
    <div class="py-3 py-lg-7">
        <h6 class="font-weight-medium font-size-7 text-center my-1" style="color: white">Contact Us</h6>
    </div>
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9689.227937997224!2d77.40420576241938!3d23.2136448877021!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c42e43fe40941%3A0x10377d4af64ac6e9!2sMaulana%20Azad%20National%20Institute%20of%20Technology%2C%20Bhopal%2C%20Madhya%20Pradesh!5e0!3m2!1sen!2sin!4v1628569872961!5m2!1sen!2sin"
                    ...
                    <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-3">
                        <div class="ml-xl-4">
                            ...
                            <div class="mb-4 mb-lg-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h6 class="font-weight-medium font-size-4 mb-4">Manit Bhopal</h6>
                                        ...
                                        <div>
                                            <a href="mailto:sale@bookworm.com"
                                                class="font-size-2 d-block link-black-100 mb-1">support@ecellnitb.com</a>
                                            <a href="tel:+919589255239" class="font-size-2 d-block link-black-100">+91
                                                9589255239</a>
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-6">
                            ...
                            <div class="mb-5 mb-xl-9 pb-xl-1">
                                ...
                                <ul class="list-unstyled mb-0 d-flex">
                                    <li class="btn pl-0">
                                        <a class="link-black-100" href="https://www.instagram.com/ecell_nitb/">
                                            <span class="fab fa-instagram"></span>
                                        </a>
                                    </li>
                                    <li class="btn">
                                        <a class="link-black-100" href="https://www.facebook.com/ecellnitbhopal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="js-form-message">
                                                ...
                                                <input id="exampleFormControlInput1" type="text"
                                                    class="form-control rounded-0" name="name" aria-label="Jack Wayley"
                                        ...
                                        <div class="col-sm-12 mb-5">
                                            <div class="js-form-message">
                                                ...
                                                <input id="exampleFormControlInput3" type="text"
                                        ...
                                        <div class="col d-flex justify-content-lg-start">
                                            <button type="submit"
                                                class="btn btn-wide btn-dark text-white rounded-0 transition-3d-hover height-60">Submit
                                                Message</button>
                                        </div>
                                    </div>
                                </form>
...
<script type="text/javascript">
    ...
    $("#form").on("submit", function(event) {
        ...
        var post_url = "/api/contactUs"; //get form action url

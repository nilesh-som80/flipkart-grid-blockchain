            ...
            <div id="primary" class="content-area order-2">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-one-example1" role="tabpanel"
                        ...
                        <ul class="products list-unstyled row no-gutters row-cols-2 row-cols-lg-3 row-cols-wd-4 border-top border-left mb-6" style="justify-content: center;"
                            id="books">
                        ...
                        <ul
                            ...
                            <button id="prev" style="border: 0; background: transparent;"><i class="fas fa-arrow-left" style="font-size: 1.2rem; color: black; padding:0px 9px;"></i>Previous</button>
                            ...
                            <button id="next" style="border: 0; background: transparent;">Next <i class="fas fa-arrow-right" style="font-size: 1.2rem; color: black;padding:0px 9px;"></i></button>
                        </ul>
...
<script>
    ...
    function get_number_of_pages() {
        ...
        $.ajax({
            url: `/api/searchByBook?keyword=${keyword}&page=${current_page}`,
            type: "get",
    ...
    $('#next').click(function (event) {
        ...
        if (current_page === last_page) {
            ...
            $.ajax({
                url: `/api/searchByBook?keyword=${keyword}&page=${current_page + 1}`,
                type: "get",
                success: function (response) {
                    console.log(response);
                    current_page = response.current_page;
    ...
    <div max-width =  269px   max-height= 400px class="product product__space product__space-primary border rounded-md bg-white mb-5">
        ...
        background: transparent;" data_id_1="${book.book_id}" data_id_2="${book.seller_id}" data_id_3="${book.discount_price}"

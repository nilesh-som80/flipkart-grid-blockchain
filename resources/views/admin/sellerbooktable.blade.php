        ...
        fetch('/api/sellersBook')
            ...
            .then((data) => {
                ...
                Array.from(data).forEach(element => {
                    ...
                    newelement.innerHTML = `<td>${element.seller_id}</td><td>${element.book_id}</td><td>${element.price}</td><td>${element.discount_price}</td>
            <td>${element.discount_percent}</td><td>${element.old_or_new}</td><td>${element.binding}</td><td>${element.current_stock}</td>
            <td>${element.total_stock}</td>`
